...
```
nihreporter <command> [arguments] [flags]
```

Run `nihreporter <command> --help` for the full flag list on any command. This
...
per operation you declare in `nihreporter/domain.go`.
