...
Most of these come down to network reality or how nihreporter serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

nihreporter rate-limits like any public site. nihreporter already paces
...
Where a surface is gated, nihreporter reads a cookie or token you supply
...
`nihreporter`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what nihreporter actually did
